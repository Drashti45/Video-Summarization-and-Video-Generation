...
def object_based_summarization(filename):
    ...
    protopath = 'src\\input\\MobileNetSSD_deploy.prototxt'
    modelpath = 'src\\input\\MobileNetSSD_deploy.caffemodel'
...
# object_based_summarization("src\\input\\files\\Cricket.mp4")